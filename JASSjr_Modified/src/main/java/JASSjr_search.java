    ...
    */
    public void engage(String args[]) throws Exception {
		...
		*/
        ...
        // Add stop words implementation
        StopWord stopWord = new StopWord("stop_words.txt");

        // Add porter stemmer
        CustomPorterStemmer customPorterStemmer = new CustomPorterStemmer();
			...
			*/
            ...
            while (tokenizer.hasMoreTokens()) {
                ...
                if (stopWord.isStopWord(token)) {
                    System.out.println("Stop word found! - skipping the stop word : '" + token + "'");
                    continue;
                }

                // Porter Stemmer
                token = customPorterStemmer.stemWord(token);
